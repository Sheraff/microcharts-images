...
export const COMPONENTS = {
  ...
  "micro-donut": MicroDonut,
  "funnel": Funnel,
  "likert-strip": LikertStrip,
  "waterfall": Waterfall,
  ...
  "polar-clock": PolarClock,
  "spiral-year": SpiralYear,
  "breathing-dot": BreathingDot,
  ...
  "eta-bar": EtaBar,
  "waveform": Waveform,
  "event-raster": EventRaster,
  "rubric-strip": RubricStrip,
  "wind-barb": WindBarb,
  "star-spoke": StarSpoke,
  "minimap-strip": MinimapStrip,
  "dual-window-meter": DualWindowMeter,
  "depth-wedge": DepthWedge,
  "partition-strip": PartitionStrip,
  "calibration-strip": CalibrationStrip,
  "confusion-grid": ConfusionGrid,
  "folded-day-band": FoldedDayBand,
  "volume-profile": VolumeProfile,
  "phase-trace": PhaseTrace,
  "trace-fold": TraceFold,
  "tape-gauge": TapeGauge,
  "station-glyph": StationGlyph,
  "cohort-triangle": CohortTriangle,
  "streak-spark": StreakSpark,
  "grade-profile": GradeProfile,
